...
import { ArrowRight, Check, X, Shield, Zap, Clock, Users, MessageCircle, Star } from 'lucide-react'
    ...
    <>
      <style>{`
        ...
        .ob-problem-card {
          ...
          border-left: 3px solid var(--ob-red);
          border-radius: 12px;
        ...
        .ob-pillar {
          background: var(--ob-card);
          border: 1px solid var(--ob-border);
          border-top: 3px solid var(--ob-cyan);
          border-radius: 16px;
          padding: 2rem 1.5rem;
          position: relative;
        }
        ...
        .ob-layer:not(:last-child)::after {
          ...
          bottom: -1px;
          width: 2px;
          background: linear-gradient(to bottom, var(--ob-cyan), transparent);
          opacity: 0.25;
        }
        .ob-layer__num {
          width: 56px;
        ...
        @media (max-width: 900px) {
          .ob-receive-grid { grid-template-columns: 1fr 1fr; }
        }
        @media (max-width: 540px) {
          .ob-receive-grid { grid-template-columns: 1fr; }
        }
        .ob-receive-card {
          background: var(--ob-card);
          border: 1px solid var(--ob-border);
        ...
        .ob-receive-card:hover {
          border-color: rgba(0,212,255,0.3);
        }
        .ob-receive-card__num {
          font-size: 1.5rem;
          font-weight: 900;
          color: var(--ob-cyan);
        ...
        @media (max-width: 640px) {
          .ob-expect-grid { grid-template-columns: 1fr; }
        }
        .ob-expect-col h4 {
          font-size: 0.72rem;
          font-weight: 800;
        ...
        .ob-quote {
          ...
          background: var(--ob-surface);
          border: 1px solid var(--ob-border);
          border-left: 3px solid var(--ob-cyan);
          border-radius: 14px;
          font-style: italic;
          font-size: 1.1rem;
          color: var(--ob-muted);
        ...
        @media (max-width: 640px) {
          .ob-for-grid { grid-template-columns: 1fr; }
        }
        .ob-for-col {
          border-radius: 16px;
          padding: 2rem;
        ...
        /* ── Buttons (reuse global, define local fallback) ── */
        .ob-btn {
          display: inline-flex;
          align-items: center;
          justify-content: center;
        ...
        .ob-btn--primary:hover {
          background: #33ddff;
          box-shadow: 0 0 0 8px rgba(0,212,255,0.22);
        }
        .ob-btn--ghost {
      ...
      <div className="ob-page">
        ...
        <section className="ob-hero">
          ...
          <div className="ob-container" style={{ position: 'relative' }}>
            <div className="ob-hero__badge">
              <span /> Early Access — Limited Availability
            </div>
            <h1 className="ob-hero__title">
              One Decision.<br />
              <em>Precision Execution.</em><br />
              Consistent Results.
            </h1>
            ...
            <div className="ob-hero__cta">
              <a className="ob-btn ob-btn--primary ob-btn--lg" href="#pricing">
                Get Early Access — €500 <ArrowRight size={18} />
              </a>
              <a className="ob-btn ob-btn--ghost" href="#how-it-works">
                See How It Works
              </a>
            </div>
          </div>
            ...
            <div className="ob-problem-grid">
              <div>
                ...
                <h2 className="ob-section-title">
                  Most Traders Don't Fail<br />
                  Because <em>They're Wrong.</em>
                </h2>
                <p className="ob-body">
                ...
                <div className="ob-callout">
                  Execution is where accounts disappear.<br />
              ...
              <div className="ob-problem-cards">
                {[
                  ...
                  <div key={item.title} className="ob-problem-card">
                    <h4>{item.title}</h4>
                    <p>{item.desc}</p>
                  </div>
                ))}
        ...
        <section className="ob-section">
          <div className="ob-container">
            ...
            <h2 className="ob-section-title" style={{ maxWidth: 700 }}>
              We Don't Remove the Human.<br />
              <em>We Remove the Weakness.</em>
            </h2>
            <p className="ob-body">
            ...
            <div className="ob-pillars">
              <div className="ob-pillar">
                <div className="ob-pillar__num">01</div>
                <h3>You Decide</h3>
                <p>Set your directional bias — up or down. One clear decision per day. That's your only job.</p>
              </div>
              <div className="ob-pillar">
                <div className="ob-pillar__num">02</div>
                <h3>The System Filters</h3>
                <p>Momentum, structure, and timing must all align before any entry triggers. If they don't, no trade is taken.</p>
              </div>
              <div className="ob-pillar">
                <div className="ob-pillar__num">03</div>
                <h3>Execution is Automatic</h3>
                <p>Entries, risk, trade management, and exits. Same structure. Every single time. No emotion. No error.</p>
              </div>
            </div>
        ...
        <section className="ob-section" id="how-it-works">
          <div className="ob-container">
            ...
            <p className="ob-body">
              Every trade passes through five layers of validation. If any single layer fails,
              no trade is taken. Period.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 3rem', marginTop: '2.5rem' }}>
              <div className="ob-layers">
                {[
                  ...
                  <div key={layer.num} className="ob-layer">
                    <div className="ob-layer__num">{layer.num}</div>
                    <div className="ob-layer__content">
                      <h3>{layer.title}</h3>
                      <p>{layer.desc}</p>
                    </div>
                  </div>
            ...
            <style>{`
              @media (max-width: 768px) {
                .ob-five-layers-grid { grid-template-columns: 1fr !important; }
              }
            `}</style>
          </div>
        </section>
        ...
        <section className="ob-section">
          <div className="ob-container">
            ...
            <h2 className="ob-section-title">
              It Doesn't Replace the Trader.<br />
              <em>It Completes Them.</em>
            </h2>
            <p className="ob-body">
            ...
            <div className="ob-compare">
              <div className="ob-compare-col ob-compare-col--bad">
                ...
                {['No market context awareness', 'Over-trade in bad conditions', 'Break down during volatility', 'Require constant monitoring'].map(t => (
                  <div key={t} className="ob-compare-item">
                    <X size={15} color="var(--ob-red)" />
                    {t}
                  </div>
                ))}
              </div>
              <div className="ob-compare-col ob-compare-col--good">
                ...
                {['Human context + system execution', 'Filters out low-quality setups', 'Waits for full alignment', 'Set it and walk away'].map(t => (
                  <div key={t} className="ob-compare-item">
                    <Check size={15} color="var(--ob-green)" />
                    {t}
                  </div>
                ))}
              </div>
            ...
            <div className="ob-safety-note">
              ...
              <p>
                ...
                When conditions don't align, it simply won't trade — <strong>saving you money
                even when you were wrong.</strong> The system doesn't just find good trades.
                It keeps you out of bad ones.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="ob-section">
          <div className="ob-container">
            ...
            <p className="ob-body">
              Upon joining, you gain access to a complete system designed to make your trading
              process structured, simple, and consistent.
            </p>
            ...
            <div className="ob-expect-grid">
              <div className="ob-expect-col ob-expect-col--yes">
                ...
                {[
                  ...
                  'Consistent behavior on every trade',
                  'Safety filters that protect you when wrong',
                  'A process that takes minutes per day',
                  'Continuous support and improvements',
                ].map(t => (
                  <div key={t} className="ob-expect-item">
                    <Check size={15} color="var(--ob-green)" /> {t}
                  </div>
                ))}
              </div>
              <div className="ob-expect-col ob-expect-col--no">
                ...
                {[
                  ...
                  'Winning every trade or every day',
                  'A system requiring zero input from you',
                  'Immediate or overnight results',
                  'A shortcut to replace discipline',
                ].map(t => (
                  <div key={t} className="ob-expect-item">
                    <X size={15} color="var(--ob-red)" /> {t}
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="ob-container">
            ...
            <div className="ob-for-grid">
              <div className="ob-for-col ob-for-col--yes">
                ...
                {[
                  'You want a structured approach to trading',
                  'You understand direction but struggle with execution',
                  'You\'re willing to follow a clear process',
                  'You prefer clarity over complexity',
                  'You want to reduce emotional decisions',
                  'You can make one simple daily decision',
                ].map(t => (
                  <div key={t} className="ob-for-item">
                    <Check size={15} color="var(--ob-green)" /> {t}
                  </div>
                ))}
              </div>
              <div className="ob-for-col ob-for-col--no">
                ...
                {[
                  ...
                  'You want zero input or responsibility',
                  'You won\'t follow rules or a process',
                  'You override systems on impulse',
                  'You expect constant trades or instant results',
        ...
        <section className="ob-section" id="pricing">
          <div className="ob-container">
            ...
            <div className="ob-pricing-wrap">
              ...
              <p className="ob-price-lock">
                🔒 Your entry price is locked in forever. Later phases will only be more expensive.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="ob-section">
          <div className="ob-container">
            ...
            <div className="ob-faq">
              {[
                { q: 'Do I need trading experience?', a: <><strong>No.</strong> The system has been designed to simplify the process as much as possible. Your only responsibility is to determine whether you expect price to move up or down. By using our tool, you will learn more along the way.</> },
          ...
          <div className="ob-container">
            <div className="ob-cta">
              ...
              <p className="ob-cta-note">
                ...
                <a href="https://discord.gg/your-invite-code" style={{ color: 'var(--ob-cyan)' }} target="_blank" rel="noopener noreferrer">
                  Discord
                </a>{' '}
                or visit{' '}
                <a href="https://www.tradewithorca.com" style={{ color: 'var(--ob-cyan)' }}>
                  tradewithorca.com
                </a>
              </p>
            </div>
