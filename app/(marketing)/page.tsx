      ...
      <div className="lp">
        ...
        <section className="sec band" id="screener">
          <div className="wrap stack-40">
            ...
            <div className="jrn-two">
              <figure className="shot">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/assets/screener-detail.jpg" width={1700} height={937} alt="AUDUSD detail view with a price chart and ML forecast fan, the Orca status and score, the multi-timeframe breakdown, ADX and EMA readings, and an itemised score breakdown out of 100." loading="lazy" />
        ...
        <section className="sec" id="journal">
          <div className="wrap stack-40">
            ...
            <figure className="shot">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/assets/journal-dashboard.jpg" width={1600} height={1318} alt="The OrcaJournal dashboard: process followed 92 percent, no trade share 52 percent, a strip of the last 24 decisions, a cumulative R curve, and the Orca Improvement Center." loading="lazy" />
              <figcaption>Process followed 92%. No trade share 52%. Net result is on the page, but it is not the first thing you see, and that is deliberate.</figcaption>
            </figure>
            ...
            <div className="jrn-two">
              <figure className="shot">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/assets/journal-decision.jpg" width={1300} height={918} alt="An expanded journal entry for a CADJPY trade showing all seven OTOS stages." loading="lazy" />
                <figcaption>One decision, opened up. The screener context it was taken in, then all seven stages, then the lesson.</figcaption>
              </figure>
              <figure className="shot">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/assets/journal-calendar.jpg" width={1300} height={772} alt="A monthly calendar of daily results with teal discipline days marking dates where the only decisions were clean no-trades." loading="lazy" />
                <figcaption>Teal days are discipline days: dates where the only decision was a clean no trade. Most journals leave those blank.</figcaption>
              </figure>
            </div>
